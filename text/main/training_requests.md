It's not easy to spontaneously join raid trainings we host here in RTI, especially if you don't check Discord every minute. This is a channel you can use to request wings or bosses to be trained on.
`-------------------------------------------------`
**How does it work?**
