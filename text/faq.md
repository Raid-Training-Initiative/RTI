...
_ _
`[8] Do I need full ascended gear to join or raid with you?`
...
_ _
`[12] What are the bots that I see people sending commands to?`
Read the #bot_spam channel's description to get an overview of each Discord bot that we use.
_ _
`[13] What is an API key? How and why should I use it?`
...
_ _
`[16] Can anyone organise a raid / training run?`
